                ...
                <div class="col-md-5 col-sm-12 mx-auto">
                    <div class="card pt-4 shadow-lg rounded" style="border-radius: 15px;">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" novalidate action="{{ url('home/aksilogin') }}" method="POST" onsubmit="return validateForm();">
                            @csrf
...
<?php endif; ?>
                                ...
                                <div id="offline-captcha" style="display:none;">
                                    ...
                                    <img src="{{ route('home.generateCaptcha') }}" alt="CAPTCHA">
